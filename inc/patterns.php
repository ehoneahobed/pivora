...
function pivora_register_patterns(): void {
	$patterns = array(
		...
		array(
			'name'       => 'pivora/cta-sale-split',
			'title'      => __( 'Sale split CTA', 'pivora' ),
			'categories' => array( 'pivora-ctas', 'pivora-ecommerce' ),
			'file'       => 'patterns/cta-sale-split.php',
			'viewport'   => 1200,
		),
		array(
			'name'       => 'pivora/cta-app-download',
			'title'      => __( 'App download CTA', 'pivora' ),
			'categories' => array( 'pivora-ctas', 'pivora-saas' ),
			'file'       => 'patterns/cta-app-download.php',
			'viewport'   => 1200,
		),
		array(
			'name'       => 'pivora/cta-split-visual',
			'title'      => __( 'Split visual CTA', 'pivora' ),
			'categories' => array( 'pivora-ctas', 'pivora-business', 'pivora-saas' ),
			'file'       => 'patterns/cta-split-visual.php',
			'viewport'   => 1200,
		),
		array(
			'name'       => 'pivora/cta-email-signup',
			'title'      => __( 'Email signup CTA', 'pivora' ),
			'categories' => array( 'pivora-ctas', 'pivora-sections' ),
			'file'       => 'patterns/cta-email-signup.php',
			'viewport'   => 1200,
		),
		array(
